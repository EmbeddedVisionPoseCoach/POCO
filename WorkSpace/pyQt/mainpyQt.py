...
class MainWindow(QMainWindow):
    ...
    def has_baseline(self):
        pose_baseline_exists = self.resolve_workspace_path(config.BASELINE_PATH).exists()
        face_baseline_exists = self.resolve_workspace_path(config.FACE_BASELINE_PATH).exists()

        return pose_baseline_exists and face_baseline_exists
